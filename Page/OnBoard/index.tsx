...
export default function OnBoard() {
    ...
    switch (currentStep) {
      case 1:
        return {
          ...
          description: "Create your permanent email in minutes. Secure, private, and censorship-resistant.",
        }
      case 2:
        return {
          icon: <User className="h-4 w-4" />,
          title: "Tell us a bit about yourself.",
          description: "Create your profile to personalize your permanent email experience.",
        }
      case 3:
        return {
          icon: <Key className="h-4 w-4" />,
          title: "Generating your encryption keys.",
          description: "We're creating secure keys to ensure your emails remain private and protected.",
        }
      case 4:
        return {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <Step2Profile onNext={handleStep2Complete} onBack={() => setCurrentStep(1)} />
      case 3:
        return <Step3Keys onNext={handleStep3Complete} onBack={() => setCurrentStep(2)} />
      case 4:
  ...
  return (
    <OnboardLayout currentStep={currentStep} icon={icon} title={title} description={description}>
      {renderStep()}
    </OnboardLayout>
  )
}
