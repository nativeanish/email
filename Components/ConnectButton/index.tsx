...
export default function ConnectButton() {
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        <button
          className={`${buttonPadding[size]} font-bold ${textSize[size]} ${
            theme === "dark"
              ? "text-gray-200"
              : theme === "light"
              ? "text-gray-800"
        ...
        >
          ...
          {selectedWallet === "ethereum" && (
            <div
              className={`${iconSize[size]} rounded-full bg-transparent flex items-center justify-center`}
            >
              <Metamask />
            </div>
          )}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`absolute right-0 mt-1 w-40 rounded-md shadow-lg ${
              theme === "dark"
